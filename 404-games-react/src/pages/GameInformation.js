                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="row mt-4 " >
                            <p>
                                <a className="btn btn-success text-light"> Buy Now</a> &nbsp; <a className="btn btn-danger text-light"><i className="fa fa-cart-plus" aria-hidden="true"></i>  Add To Cart</a> <br/><br/>
                            </p>
                        </div>
